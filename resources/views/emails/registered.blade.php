...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider mobile_hide" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
    ...
    <div style="background-color:transparent;">
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffd500;" class="block-grid ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#ffd500;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#ffd500;"><![endif]-->
...
<div style="line-height:25px;font-size:1px">&#160;</div>  <img class="left fixedwidth" align="left" border="0" src="images/uRJamr3RpRWUci8rFIKb.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 348px" width="348">
...
<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="color:#686767;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:14px;color:#686767;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 16px; line-height: 19px;">Спасибо за то, что выбрали наш интернет магазин!&#160;</span><br><span style="font-size: 16px; line-height: 19px;">Ваш логин: <span style="color: rgb(255, 191, 0); font-size: 16px; line-height: 19px;"><strong>{{ $request->email }}</strong></span></span></p><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 16px; line-height: 19px;"><span style="color: rgb(255, 191, 0); font-size: 16px; line-height: 19px;"><span style="color: rgb(128, 128, 128); font-size: 16px; line-height: 19px;">Ваш пароль</span><strong><span style="color: rgb(128, 128, 128); font-size: 16px; line-height: 19px;">:</span> {{ $pass }}</strong></span></span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style="color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 15px; padding-bottom: 15px;">	
		<div style="font-size:12px;line-height:14px;color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 16px; font-family: inherit; background-color: transparent; line-height: 19px;">Вы получили пароль, по которому можете зайти в свой личный кабинет.</span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="left" class="button-container left " style="padding-right: 10px; padding-left: 10px; padding-top:5px; padding-bottom:35px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:5px; padding-bottom:35px;" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:31pt; v-text-anchor:middle; width:163pt;" arcsize="120%" strokecolor="#FFD500" fillcolor="#FFD500"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#132F40; font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size:16px;"><![endif]-->
    <div style="color: #132F40; background-color: #FFD500; border-radius: 50px; -webkit-border-radius: 50px; -moz-border-radius: 50px; max-width: 218px; width: 178px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: center; mso-border-alt: none;">
      <span style="font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;line-height:32px;"><span style="font-size: 15px; line-height: 30px;"><strong><a href="localhost:8000/login" style="line-height: 30px; font-size: 15px;">В ЛИЧНЫЙ КАБИНЕТ &gt;</a></strong></span></span>
    </div>
  <!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->
    ...
    <div style="background-color:transparent;">
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #132f40;" class="block-grid ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#132f40;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#132f40;"><![endif]-->
